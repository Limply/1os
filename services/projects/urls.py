...
from .views import ProjectViewSet, TaskViewSet, TaskPhotoViewSet, TaskDocumentViewSet, TaskCommentViewSet, ProjectCommentViewSet, DailyReportViewSet, WSHPhotoViewSet, WSHPhotoAttachmentViewSet, task_templates
...
router.register('wsh-photo-attachments', WSHPhotoAttachmentViewSet, basename='wsh-photo-attachment')
