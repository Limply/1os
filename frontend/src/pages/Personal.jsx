...
const TASK_STATUS_STYLE = {
  ...
  review:      { dot: 'bg-yellow-500', label: 'Review' },
...
export default function Personal() {
  ...
  const [me, setMe]       = useState(null)   // { employee, leave_balances, leave_applications, today_attendance }
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      {/* Employee info — only if profile exists */}
      {emp && (
        <div className="bg-white rounded-xl border border-gray-200 p-4">
